...
public class Utils {
    ...
    public static final boolean DEBUG = false; //Set to true only when developing
    ...
    public static int computeMeasureSize(int measureSpec, int defSize) {
    ...
    public static float computeCircleX(float r, float degrees) {
        return (float) (r * Math.cos(Math.toRadians(degrees)));
    }

    public static float computeCircleY(float r, float degrees) {
        return (float) (r * Math.sin(Math.toRadians(degrees)));
    }

    public static int computeWidth(int origin, int size, int x) {
    ...
    public static int computeHeight(int origin, int size, int y) {
