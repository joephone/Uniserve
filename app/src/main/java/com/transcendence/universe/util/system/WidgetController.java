...
public class WidgetController {
	private static String tag = "WidgetController";
	 ...
	 */
	public static void setLayout(ImageView view, int x, int y) {

		MarginLayoutParams margin = new MarginLayoutParams(
				view.getLayoutParams());
		Log.i(tag, "margin.width:" + margin.width + "----margin.height:"
				+ margin.height);
		// margin.setMargins(x, y, x + margin.width, y + margin.height);
		margin.setMargins(x, y, -x, -y);
		RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(
				margin);
