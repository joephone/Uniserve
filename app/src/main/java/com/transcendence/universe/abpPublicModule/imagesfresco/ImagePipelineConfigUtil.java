 ...
 * fresco 设置
 */
public class ImagePipelineConfigUtil {
   static String tag="ImagePipelineConfigUtil";
    //分配的可用内存
    ...
    public static ImagePipelineConfig getDefaultImagePipelineConfig(Context context, OkHttpClient okHttpClient) {
    ...
    public static void   clearCach(){
        ...
        NoOpMemoryTrimmableRegistry.getInstance().registerMemoryTrimmable(new MemoryTrimmable() {
            ...
            public void trim(MemoryTrimType trimType) {
                ...
                Log.i(tag,String.format("onCreate suggestedTrimRatio : %d", suggestedTrimRatio));
