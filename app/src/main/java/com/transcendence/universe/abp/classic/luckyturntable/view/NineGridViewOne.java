...
/**
 * Created by Joephone on 2018/12/18 10:28
 * E-Mail Address：joephonechen@gmail.com
 */

public class NineGridViewOne extends SurfaceView implements Callback{
    ...
    public NineGridViewOne(Context context, AttributeSet attrs) {
        super(context, attrs);
        mHolder = this.getHolder();
        mHolder.addCallback(this);
    }

    public NineGridViewOne(Context context) {
        this(context,null);
    }
