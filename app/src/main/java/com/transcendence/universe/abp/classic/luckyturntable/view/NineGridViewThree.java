...
public class NineGridViewThree extends FrameLayout {
    ...
    public NineGridViewThree(@NonNull Context context) {
        this(context, null);
    }

    public NineGridViewThree(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NineGridViewThree(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        inflate(context, R.layout.nine_grid_lucky3_panel, this);
        setupView();
    }
    ...
    public void startGame() {
        Log.e("LuckyMonkeyPanelView", "startGame");
        isGameRunning = true;
        isTryToStop = false;
        currentSpeed = DEFAULT_SPEED;
        new Thread(new Runnable() {
