package com.transcendence.universe.abp.ui.widget.recycler.act;
...
import com.transcendence.universe.abp.ui.widget.recycler.flyrefresh.bean.ItemData;
import com.transcendence.universe.abp.ui.widget.recycler.flyrefresh.bean.SampleItemAnimator;
...
public class FlyRefreshMainAct extends AppCompatActivity implements FlyRefreshLayout.OnPullRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initDataSet();
        setContentView(R.layout.fly_refresh_main);
    ...
    private void initDataSet() {
        mDataSet.add(new ItemData(Color.parseColor("#76A9FC"), R.drawable.ic_assessment_white_24dp, "Meeting Minutes", new Date(2014 - 1900, 2, 9)));
    ...
    private class ItemAdapter extends RecyclerView.Adapter<ItemViewHolder> {
        ...
        public void onBindViewHolder(ItemViewHolder itemViewHolder, int i) {
            ...
            drawable.getPaint().setColor(data.getColor());
