...
//        Logger.setDebug(true);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        MinValue -= DensityUtils.dip2px(context,10)*2;
        Logs.d("screenWidth = "+screenWidth + "screenHeight = "+screeHeight + "MinValue = "+MinValue);
    ...
    private void drawSmallCircle(boolean FirstYellow){
        ...
        for(int i=0;i<=360;i+=20){
            int x = (int) (pointDistance * Math.sin(DensityUtils.change(i))) + CircleX;
            int y = (int) (pointDistance * Math.cos(DensityUtils.change(i))) + CircleY;
