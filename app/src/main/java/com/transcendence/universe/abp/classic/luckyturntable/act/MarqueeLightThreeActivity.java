...
public class MarqueeLightThreeActivity extends TitleBarActivity {


    private NineGridViewThree luckyPanelView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nine_grid_lucky3);

        luckyPanelView = (NineGridViewThree) findViewById(R.id.lucky_panel);
    ...
    private void getLuck() {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (MarqueeLightThreeActivity.this.isFinishing()) {
                    return;
                }
