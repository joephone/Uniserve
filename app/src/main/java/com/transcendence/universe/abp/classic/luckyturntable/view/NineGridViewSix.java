...
/**
 * Created by Joephone on 2019/1/23 20:32
 * E-Mail Address：joephonechen@gmail.com
 */

public class NineGridViewSix extends SurfaceView implements Callback {
    ...
    public NineGridViewSix(Context context, AttributeSet attrs) {
        super(context, attrs);
        mHolder = this.getHolder();
        mHolder.addCallback(this);
    }

    public NineGridViewSix(Context context) {
        this(context, null);
    }
