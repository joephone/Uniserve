...
/**
 * Created by Joephone on 2018/10/26 15:10
...
public class CryptoObjectCreator {
            ...
            public void run() {
                try {
                    if (mCryptoObject != null) {
                        ...
                        // of the fingerprint.
                        if (!initCipher()) {
                            Logs.logE("Failed to init Cipher.");
                        }
                    }
                } catch (Exception e) {
                    Logs.logE(" Failed to init Cipher, e:" + Log.getStackTraceString(e));
                }
    ...
    private void createKey() {
        ...
        try {
            ...
            Logs.logE(" Failed to createKey, e:" + Log.getStackTraceString(e));
    ...
    private boolean initCipher() {
        try {
            ...
            Logs.logE(" Failed to initCipher, e:" + Log.getStackTraceString(e));
            return false;
