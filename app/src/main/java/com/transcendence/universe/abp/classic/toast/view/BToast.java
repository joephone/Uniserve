package com.transcendence.universe.abp.classic.toast.view;
    ...
    private static void showToast(Context context, CharSequence text, int time, int imgType) {
        ...
        if (imgType == TYPE_HIDE) {
            ...
            if (imgType == TYPE_TRUE) {
                toast_img.setBackgroundResource(R.drawable.ic_success);
            } else {
                toast_img.setBackgroundResource(R.drawable.ic_error);
            }
