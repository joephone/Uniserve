...
public class NineGridViewClassic extends FrameLayout {

    private ImageView bg_1;
    private ImageView bg_2;

    private NineGridViewClassicItem itemView1, itemView2, itemView3,
            itemView4, itemView6,
    ...
    public NineGridViewClassic(@NonNull Context context) {
        this(context, null);
    }

    public NineGridViewClassic(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NineGridViewClassic(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        inflate(context, R.layout.nine_grid_lucky_classic_panel, this);
        setupView();
    }
    ...
    private void setupView() {
        ...
        itemView1 = (NineGridViewClassicItem) findViewById(R.id.item1);
        itemView2 = (NineGridViewClassicItem) findViewById(R.id.item2);
        itemView3 = (NineGridViewClassicItem) findViewById(R.id.item3);
        itemView4 = (NineGridViewClassicItem) findViewById(R.id.item4);
        itemView6 = (NineGridViewClassicItem) findViewById(R.id.item6);
        itemView7 = (NineGridViewClassicItem) findViewById(R.id.item7);
        itemView8 = (NineGridViewClassicItem) findViewById(R.id.item8);
        itemView9 = (NineGridViewClassicItem) findViewById(R.id.item9);
