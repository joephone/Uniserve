...
//                Toast.makeText(WeiboTabActivity.this, "Center Btn is Clicked.", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(WeiboTabActivity.this, IndexAct.class);
    ...
    public class FragmentAdapter extends FragmentStatePagerAdapter implements
        ...
        public Integer getPageIcon(int index) {
            if (index >= 0 && index < VIEW_SIZE) {
                switch (index) {
                    ...
                    case VIEW_SECOND:
                        return R.drawable.tabbar_message_center;
                    case VIEW_THIRD:
                        return R.drawable.tabbar_discover;
                    case VIEW_FOURTH:
        ...
        public Integer getPageSelectIcon(int index) {
            if (index >= 0 && index < VIEW_SIZE) {
                switch (index) {
                    case VIEW_FIRST:
                        return R.drawable.tabbar_home_selected;
                    case VIEW_SECOND:
                        return R.drawable.tabbar_message_center_highlighted;
                    case VIEW_THIRD:
                        return R.drawable.tabbar_discover_highlighted;
                    case VIEW_FOURTH:
                        return R.drawable.tabbar_profile_highlighted;
                    default:
                        break;
                }
            }
